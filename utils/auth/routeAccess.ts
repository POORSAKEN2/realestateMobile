...
export const ROUTE_PERMISSIONS: Readonly<Record<string, AppPermission>> = {
  properties: "properties.viewAny", "property-details": "properties.viewAny", mapCanvas: "properties.viewAny", expenses: "expenses.viewAny",
...
export const PROPERTY_ROUTES = new Set([
  "properties", "property-details", "mapCanvas", "expenses", "tenants", "leases", "rent", "documents", "bookings",
