...
export const appRoutes = {
  ...
  secondary: {
    ...
    workspaceSettings: "/(secondary)/workspace-settings" as Href,
    auditHistory: "/(secondary)/audit-history" as Href,
    deletionRequests: "/(secondary)/deletion-requests" as Href,
    ...
    inquiryDetails: "/(secondary)/inquiry-details" as Href,
    propertyDetails: "/(secondary)/property-details",
    rent: "/(secondary)/rent",
...
const moduleRoutes: Record<string, Href> = {
  ...
  "audit-history": appRoutes.secondary.auditHistory,
  "deletion-requests": appRoutes.secondary.deletionRequests,
